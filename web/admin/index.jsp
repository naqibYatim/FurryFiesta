...
<div id="adminMenu" class="alignLeft">
    <p id="linkPageAdmin"><a href="<c:url value='viewCustomers'/>">view all customers</a></p>

    <p id="linkPageAdmin"><a href="<c:url value='viewOrders'/>">view all orders</a></p>

    <p id="linkPageAdmin"><a href="../">customer main page</a></p>
</div>
