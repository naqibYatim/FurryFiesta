...
public class ControllerServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setCharacterEncoding("UTF-8");  // ensures that user input is interpreted as
                                                // 8-bit Unicode (e.g., for Malay characters)
        ...
        // if purchase action is called
            ...
            if (cart != null) {
                ...
                if (validationErrorFlag == true) {
                    ...
                    userPath = "/checkout";
                    //System.out.println("validationErrorFlag true");

                    // otherwise, save order to database
                } else {
                    //System.out.println("validationErrorFlag false");
                    // this orderId shit makes the app not functioning properly
